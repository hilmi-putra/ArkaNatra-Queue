<!-- Delete User Modal -->
<div id="hs-delete-user-modal"
    class="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto" role="dialog"
    tabindex="-1" aria-labelledby="hs-delete-user-modal-label">

    <!-- WRAPPER utama Preline - HAPUS data-hs-overlay dari sini -->
    <div
        ...
        <!-- HAPUS data-hs-overlay="#hs-delete-user-modal" dari div ini -->
        ...
        <div
            ...
            <div class="absolute top-2 end-2">
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-delete-user-modal">
            ...
            <div class="p-4 sm:p-10 overflow-y-auto">
                <div class="flex gap-x-4 md:gap-x-7">
                    ...
                    <div class="grow">
                        <h3 id="hs-delete-user-modal-label"
                        ...
                        <div class="text-sm bg-gray-50 dark:bg-neutral-800 p-4 rounded-lg mb-4 space-y-3">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-medium text-gray-800 dark:text-neutral-200"
                                    id="modal-user-email">—</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-600 dark:text-neutral-400 font-medium">Role:</span>
                                <span class="font-medium text-blue-600 dark:text-blue-400" id="modal-user-role">—</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-600 dark:text-neutral-400 font-medium">Divisi:</span>
                                <span class="font-medium text-gray-800 dark:text-neutral-200"
                                    id="modal-user-division">—</span>
                            </div>
                        </div>
...
<script>
    window.addEventListener('load', () => {
        ...
        const modalUserDivision = document.getElementById('modal-user-division');
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                modalUserDivision.textContent = userDivision;
                userIdInput.value = userId;

                // Set the form action URL
                // The base URL is retrieved from a global variable or a data attribute on a meta tag if needed
                let baseUrl = "{{ url('admin/users') }}";
                deleteForm.action = `${baseUrl}/${userId}`;
            });
        });
    });
</script>