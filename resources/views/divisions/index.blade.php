                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div
                        ...
                        <div
                            ...
                            <div>
                                <h2 class="text-xl font-semibold text-gray-800 dark:text-neutral-200">Divisions</h2>
                                <p class="text-sm text-gray-600 dark:text-neutral-400">Daftar divisi beserta informasi
                                    relasinya.</p>
                            </div>
                                ...
                                <thead class="bg-gray-50 dark:bg-neutral-800">
                                    <tr>
                                        <th class="ps-6 py-3 text-start">
                                            <span
                                                class="text-xs font-semibold text-gray-800 dark:text-neutral-200 uppercase">No</span>
                                        </th>

                                        <th class="px-6 py-3 text-start">
                                            <span
                                                class="text-xs font-semibold text-gray-800 dark:text-neutral-200 uppercase">Nama
                                                Divisi</span>
                                        </th>

                                        <th class="px-6 py-3 text-start">
                                            <span
                                                class="text-xs font-semibold text-gray-800 dark:text-neutral-200 uppercase">Total
                                                Users</span>
                                        </th>

                                        <th class="px-6 py-3 text-start">
                                            <span
                                                class="text-xs font-semibold text-gray-800 dark:text-neutral-200 uppercase">Work
                                                Types</span>
                                        </th>
                                        ...
                                        <th class="px-6 py-3 text-end">
                                            <span
                                                class="text-xs font-semibold text-gray-800 dark:text-neutral-200 uppercase">Aksi</span>
                                        </th>
                                    </tr>
                                </thead>
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="py-2 first:pt-0 last:pb-0">
                                                                ...
                                                                <button type="button"
                                                                    class="delete-division-btn flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-red-600 hover:bg-red-100 focus:outline-hidden focus:bg-red-100 dark:text-red-500 dark:hover:bg-red-500/10 dark:focus:bg-red-500/10 w-full"
                        ...
                        @else
                            ...
                            <div class="max-w-sm w-full mx-auto px-6 py-16 text-center">
                                ...
                                <h2 class="mt-5 text-gray-800 font-semibold dark:text-white">Tidak ada data division</h2>
                                <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                                    Tambahkan division baru untuk mengisi data.
                                </p>
                            </div>
                        @endif
