<!-- Delete Work Order Indexing Modal -->
<div id="hs-delete-work-order-indexing-modal"
    class="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto" role="dialog"
    tabindex="-1" aria-labelledby="hs-delete-work-order-indexing-modal-label">
        ...
        <div
            ...
            <div class="absolute top-2 end-2">
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-delete-work-order-indexing-modal">
            ...
            <div class="p-4 sm:p-10 overflow-y-auto">
                <div class="flex gap-x-4 md:gap-x-7">
                    ...
                    <div class="grow">
                        <h3 id="hs-delete-work-order-indexing-modal-label"
                            class="mb-2 text-xl font-bold text-gray-800 dark:text-neutral-200">
                            Konfirmasi Penghapusan Indexing
                        </h3>
                        <p class="text-gray-500 dark:text-neutral-500 mb-4">
                            Apakah Anda yakin ingin menghapus data indexing berikut?
                        </p>

                        <div class="text-sm bg-gray-50 dark:bg-neutral-800 p-4 rounded-lg mb-4 space-y-3">
                            <div class="flex justify-between items-center">
                                <span class="text-gray-600 dark:text-neutral-400 font-medium">Work Order:</span>
                                <span class="font-semibold text-gray-800 dark:text-neutral-200"
                                    id="modal-item-workorder">—</span>
                            </div>
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-medium text-gray-800 dark:text-neutral-200"
                                    id="modal-item-customer">—</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-600 dark:text-neutral-400 font-medium">Indexing Type:</span>
                                <span class="font-medium text-blue-600 dark:text-blue-400"
                                    id="modal-item-indexing">—</span>
                            </div>
                        </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="text-sm">
                                    ...
                                    <p class="text-yellow-700 dark:text-yellow-500 mt-1">
                                        Semua data terkait indexing ini akan dihapus secara permanen.
                                    </p>
                                </div>
                            </div>
                        </div>
...
<script>
    window.addEventListener('load', () => {
        ...
        const deleteButtons = document.querySelectorAll('.delete-work-order-indexing-btn');
        const modalWorkOrder = document.getElementById('modal-item-workorder');
        const modalCustomer = document.getElementById('modal-item-customer');
        const modalIndexing = document.getElementById('modal-item-indexing');
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                const itemWorkorder = button.getAttribute('data-item-workorder');
                const itemCustomer = button.getAttribute('data-item-customer');
                const itemIndexing = button.getAttribute('data-item-indexing');

                modalWorkOrder.textContent = itemWorkorder;
                modalCustomer.textContent = itemCustomer;
                modalIndexing.textContent = itemIndexing;
                itemIdInput.value = itemId;

                let baseUrl = "{{ url('asservice/work-order-indexing') }}";
