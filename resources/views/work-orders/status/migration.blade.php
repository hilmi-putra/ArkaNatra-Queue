                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div
                        ...
                        <div
                            ...
                            <div>
                                <h2 class="text-xl font-semibold text-gray-800 dark:text-neutral-200">Work Orders - Migration
                                </h2>
                                <p class="text-sm text-gray-600 dark:text-neutral-400">Daftar Work Order yang sedang dalam
                                    proses migrasi.</p>
                            </div>
                            ...
                            <thead class="bg-gray-50 dark:bg-neutral-800">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-start">
                                        <div class="flex items-center gap-x-2">
                                            <span
                                                class="text-xs font-semibold uppercase text-gray-800 dark:text-neutral-200">Marketing</span>
                                        </div>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-start">
                                        <div class="flex items-center gap-x-2">
                                            <span
                                                class="text-xs font-semibold uppercase text-gray-800 dark:text-neutral-200">Production</span>
                                        </div>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-start">
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    @php
                                                        ...
                                                        $currentColor = $statusColors[$order->status] ?? [
                                                            'bg-gray-100',
                                                            'text-gray-800',
                                                        ];
                                                    @endphp
                                                    ...
                                                    @if (auth()->user()->hasRole('production'))
                                                        <div class="hs-dropdown relative inline-flex">
                                                            <button id="hs-dropdown-status-{{ $order->id }}"
                                                                type="button"
                                                                ...
                                                                <span
                                                                    class="py-0.5 px-2 rounded-full bg-white text-gray-800">
                                ...
                                @else
                                    <tr>
                                        <td colspan="9" class="text-center py-10">
                                            <div
                                                class="max-w-sm w-full min-h-100 flex flex-col justify-center mx-auto px-6 py-4">
                                                <div
                                                ...
                                                <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                                                    Belum ada Work Order dengan status ini atau tidak ada yang sesuai dengan
                                                    role Anda.
                                                </p>
                                            </div>
                                        </td>
...
@section('scripts')
    @include('work-orders.partials.status-scripts')
@endsection
