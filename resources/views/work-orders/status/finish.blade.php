                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div
                        ...
                        <div
                            ...
                            <div>
                                <h2 class="text-xl font-semibold text-gray-800 dark:text-neutral-200">Work Orders - Finish
                                </h2>
                                <p class="text-sm text-gray-600 dark:text-neutral-400">Daftar Work Order yang telah selesai
                                    dikerjakan.</p>
                            </div>
