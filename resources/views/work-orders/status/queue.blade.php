                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div
                        ...
                        <div
                            ...
                            <div>
                                <h2 class="text-xl font-semibold text-gray-800 dark:text-neutral-200">Work Orders - Queue
                                </h2>
                                <p class="text-sm text-gray-600 dark:text-neutral-400">Daftar Work Order yang menunggu
                                    antrian proses.</p>
                            </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                @include('work-orders.partials.status-table-rows', [
                                    'data' => $data,
                                    'showAntrian' => true,
                                ])
                            </tbody>
